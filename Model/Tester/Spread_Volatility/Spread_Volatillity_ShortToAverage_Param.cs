...
{
    public class Spread_Volatillity_ShortToAverage_Param
    {
        ...
        public decimal InitialMargin { get; set; } = 11000;
        ...
        public string Algo = "Spread_Volatillity_ShortToAverage_Algo";
